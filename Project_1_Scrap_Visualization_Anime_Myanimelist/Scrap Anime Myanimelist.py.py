...
def Get_Info(year):
    ...
    # Save file to folder
    directory_of_python_script = os.path.dirname(os.path.abspath(__file__))
    Anime_df.to_csv(os.path.join(directory_of_python_script, year+'_Anime.csv'), index=False)
...
if __name__ == "__main__":
    ...
    # Get year from user
    year = input('What year you want to search: ')
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(directory_of_python_script, year +'_Anime.png'))
    plt.show()
